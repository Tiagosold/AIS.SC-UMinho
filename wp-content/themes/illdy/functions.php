...
if (!function_exists('illdy_widgets')) {
    ...
    function illdy_widgets()
    {
        ...
        register_sidebar(array(
            ...
            'before_widget' => '<div id="%1$s" class="col-sm-6 col-sm-offset-0 col-xs-12 col-lg-4 col-lg-offset-0 %2$s">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
        ));
        ...
        register_sidebar(array(
            ...
            'before_widget' => '<div id="%1$s" class="col-lg-3 col-sm-6 col-xs-12 no-padding %2$s">',
            'after_widget' => '</div>',
            'before_title' => '',
            'after_title' => '',
        ));
...
{
    $response = false;
    $from = '<noreply.aisscuminho@gmail.com>';
    ...
    $html = '<html><im><h2>' . $subject . '</h2><p>' . $body . '</p>
      <p style="font-size: 12px">Sempre à disposição.</p><p style="font-size:12px">Com os melhores cumprimentos,</p><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/logo_ais_trp.png"><p style="font-size:12px; color:rgb(11,83,148)">Núcleo de Estudantes de Sistemas de Informação<br>Departamento de Sistemas de Informação<br>Campus de Azurém, 4800-058 Guimarães <br> Email: aissc@dsi.uminho.pt | Telef: 919844483<br><a href="http://ais.dsi.uminho.pt/#latest-news"><img style="margin-right:3px;" src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/site.png"/></a><a href="https://www.facebook.com/AISSC.UMINHO"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/faceb.png"/></a><a href="https://www.linkedin.com/company/ais-sc-uminho/"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/linkedin.png"/></a><a href="https://twitter.com/AISSC_UMinho"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/twitter.png"/></a><a href="https://plus.google.com/+AISSCUMinhoYP"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/g.png"/></a><a href="https://www.youtube.com/user/AISSCTV"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/youtube.png"/></a><a href="https://www.instagram.com/ais.sc.um/"><img src="http://ais.dsi.uminho.pt/wp-content/uploads/2017/10/instagram.png"/></a></p></body></html>';  // HTML version of the email
    $crlf = "\n";
    ...
    $smtp = Mail::factory('smtp', array(
        ...
        'port' => '465',
        'auth' => true,
        'username' => 'noreply.aisscuminho@gmail.com',
        'password' => 'r2pe+8y5-3'
    ));
...
function add_to_new_menu($items, $args)
{
    if ($args->theme_location == 'new-menu') {
        ...
        if (is_front_page()) {
            $items .= '<li class="perfil menu-item"><a href="#"><img alt="Perfil" class="img-circle img-responsive" style="border:0;outline:none; width:35px; height:35px; margin:0 auto" src="wp-content/themes/illdy/uploads/' . $image . '"></a></li>';
        }else {
            $items .= '<li class="perfil menu-item"><a href="#"><img alt="Perfil" class="img-circle img-responsive" style="border:0;outline:none; width:35px; height:35px; margin:0 auto;" src="../wp-content/themes/illdy/uploads/' . $image . '"></a></li>';
        }
    }
