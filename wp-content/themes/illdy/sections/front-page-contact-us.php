...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$general_title          = get_theme_mod( 'illdy_contact_us_general_title', __( 'Contacto', 'illdy' ) );
	...
	$general_address_title  = get_theme_mod( 'illdy_contact_us_general_address_title', __( 'Morada', 'illdy' ) );
	$customer_support_title = get_theme_mod( 'illdy_contact_us_general_customer_support_title', __( 'Apoio ao Cliente', 'illdy' ) );
} else {
							...
							<div class="col-sm-5">
								<div class="contact-us-box">
									...
									<div class="box-right">
										...
										<?php endif; ?>
										<?php if ( $phone ): ?>
											<span class="box-right-row" data-customizer="contact-us-phone"><?php _e( 'Telemóvel:', 'illdy' ); ?> <?php echo illdy_sanitize_html( $phone ); ?></span>
										<?php endif; ?>
									</div><!--/.box-right-->
								</div><!--/.contact-us-box-->
							</div><!--/.col-sm-5-->
