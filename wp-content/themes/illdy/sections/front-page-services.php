    ...
    <script>
        ...
        (function(yourcode) {
            ...
            yourcode(window.jQuery, window, document);
                    ...
                    $.ajax({
                        ...
                        statusCode: {
                            200: function(response){
                                var elem = $('#partners-showing');
                                var string = "";
                                $.each(response, function(index, value) {
                                    string += '<div class="gallery_product col-lg-3 col-md-4 col-sm-4 col-xs-12"><img alt="'+value.nomeParceiro+'" src="'+value.imagem+'" class="img-thumbnail"></div>';
                                });
                                elem.append(string);
                            },
                            500: function(){
                ...
                <div class="container">
                    <div id="partners-showing" class="row">
                    </div>
                </div>
				<?php /*
